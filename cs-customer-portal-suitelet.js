        ...
        <div class="card">
            ...
            >
                ...
                <div class="table-wrap">
                    <table>
                        <thead>
                            <tr id="inTransitShipmentsHeadRow"></tr>
                        </thead>
                ...
                <div class="table-wrap">
                    <table>
                        <thead>
                            <tr id="inTransitTransfersHeadRow"></tr>
                        </thead>
...
(function () {
    ...
    var DETAIL_TABS = [
        ...
        },
        {
            key: 'orderHistory',
            label: 'Order History',
            head: 'orderHistoryHeadRow',
            rows: 'orderHistoryRows',
            err: 'orderHistoryError',
            empty:
        ...
        },
        {
            key: 'openBalance',
            label: 'Open Balance',
            head: 'openBalanceHeadRow',
            rows: 'openBalanceRows',
            err: 'openBalanceError',
            empty:
                'No open balance found for this customer.',
            loading:
                'Loading open balance...'
        },
        {
            key: 'inTransitShipments',
            label: 'Shipments In Transit',
            head: 'inTransitShipmentsHeadRow',
            rows: 'inTransitShipmentsRows',
            err: 'inTransitShipmentsError',
            empty:
                'No shipments currently in transit for this customer.',
            loading:
                'Loading shipments...'
        },
        {
            key: 'inTransitTransfers',
            label: 'Transfer Orders In Transit',
            head: 'inTransitTransfersHeadRow',
            rows: 'inTransitTransfersRows',
            err: 'inTransitTransfersError',
            empty:
                'No transfer orders currently in transit for this customer.',
            loading:
    ...
    function renderDynamicRows(
        ...
        if (!columns.length) {
            body.innerHTML = emptyRow(
                1,
                'No columns found. Please check saved search results.'
            );
            return;
        }
        ...
        .map(function (row) {
            ...
            /*
             * row.internalId came from NetSuite result.id.
             * It does not need to be a saved-search column.
             */
            var dataAttr =
                clickable
                    ? ' data-customer="' +
    ...
    function refreshGrid() {
        ...
        .catch(function (e) {
            ...
            document.getElementById(
                'gridHeadRow'
            ).innerHTML = '<th>Error</th>';

            document.getElementById(
                'gridRows'
            ).innerHTML = emptyRow(
                1,
                'Unable to load customer results.'
            );
        });
    }
    ...
    function openCustomer(customerId) {
        ...
        /*
         * The clicked customer ID is sent to the Suitelet.
         */
        api('customerDetail', {
            customerId: customerId
        })
    ...
    function renderHeaderCards(header) {
        ...
        if (!columns.length) {
            document.getElementById(
                ...
                '<div class="loading">' +
                    'No customer header columns found.' +
                '</div>';
    ...
    function toCsvValue(value) {
        ...
        /*
         * FIX:
         * The backslashes are doubled because this JavaScript is contained
         * inside the outer SuiteScript template literal.
         */
        if (/[",\\n\\r]/.test(display)) {
            display =
                '"' +
    ...
    function exportCustomerDetailCsv() {
        ...
        var lines = sectionToCsvLines(
            'Customer Header',
            currentDetailData.header
        );
        ...
        /*
         * FIX:
         * Double backslashes preserve \r\n inside the generated browser
         * JavaScript instead of inserting raw line breaks in the script.
         */
        var csv = lines.join('\\r\\n');
